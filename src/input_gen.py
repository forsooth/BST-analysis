...
max_arg_len = max([len(str(x)) for x in vars(args).values()]) + 1
stamp =  "# ╔═════════════════════════════════════════" + '═' * max_arg_len + '╗' + '\n'
stamp += "# ║ Input generated by input_gen.py         " + ' ' * max_arg_len + '║' + '\n'
stamp += "# ╟─────────────────────────────────────────" + '─' * max_arg_len + '╢' + '\n'
stamp += "# ║ PARAMETERS                              " + ' ' * max_arg_len + '║' + '\n'
stamp += "# ╟─────────────────────────────────────────" + '─' * max_arg_len + '╢' + '\n'
stamp += "# ║ operation argument type: " + str(args.type) + ' ' * (15 - len(str(args.type)) + max_arg_len) + '║' + '\n'
stamp += "# ║ operations per pattern element: " + str(args.number) + ' ' * (8 - len(str(args.number)) + max_arg_len) + '║' + '\n'
stamp += "# ║ upper limit on operation arguments: " + str(args.max) + ' ' * (4 - len(str(args.max)) + max_arg_len) + '║' + '\n'
stamp += "# ║ lower limit on operation arguments: " + str(args.min) + ' ' * (4 - len(str(args.min)) + max_arg_len) + '║' + '\n'
stamp += "# ║ operation generation pattern: " + str(args.pattern) + ' ' * (10 - len(str(args.pattern)) + max_arg_len) + '║' + '\n'
stamp += "# ║ insert operation argument distribution: " + str(args.ins_distribution) + ' ' * (-len(str(args.ins_distribution)) + max_arg_len) + '║' + '\n'
stamp += "# ║ search operation argument distribution: " + str(args.sea_distribution) + ' ' * (-len(str(args.sea_distribution)) + max_arg_len) + '║' + '\n'
stamp += "# ║ delete operation argument distribution: " + str(args.del_distribution) + ' ' * (-len(str(args.del_distribution)) + max_arg_len) + '║' + '\n'
stamp += "# ║ write to timestamped file: " + str(args.write) + ' ' * (13 - len(str(args.write)) + max_arg_len) + '║' + '\n'
stamp += "# ╚═════════════════════════════════════════" + '═' * max_arg_len + '╝' + '\n'
data = [stamp]
cur_ops = []
